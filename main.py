...
valores_x, valores_y = aplicacion.abrir_document(matriz_codificacion, "datos encriptados.txt", "decifrar")
...
guardar_datos.save(desempaquetar_x, desempaquetar_y, "valores desencriptados.txt")
guardar_datos.save(valores_rotados_x, valores_rotados_y, "valores rotados.txt")
guardar_datos.save(valores_trasladados_x,valores_trasladados_y,"valores trasladados.txt")